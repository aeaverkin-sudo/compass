...
/** Trim browse card bottom edge (px; negative extends downward). −116 pulls the lower white down so the dots sit in its middle. */
export const CARD_BOTTOM_RAISE_PX = -116;
